export default {
  ...
  tokensDemoCaption:
    "Solid button, outline button, chip: none of these components specify hardcoded colors or radii. They therefore all automatically inherit this redefinition, and the behavior would be exactly the same for any other component placed in this panel.",
  tokensOklch:
