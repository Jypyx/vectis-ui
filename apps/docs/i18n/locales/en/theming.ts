export default {
  ...
  levels: [
    '<strong>Primitives</strong> — 26 OKLCH palettes of eleven steps each (<code>--vectis-color-indigo-500</code>), plus the space scale, type, radii, shadows, durations and easings.',
  ...
  palettes:
    'Five palettes are wired to roles — gray for surfaces, text and borders, indigo for the accent, and red, green and amber for danger, success and warning. The other twenty-one ship unused, so pointing a role at one of them costs nothing and waits for no release. This site does exactly that: its accent is violet.',
