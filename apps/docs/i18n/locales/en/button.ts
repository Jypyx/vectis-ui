export default {
  ...
  variantsBody:
    'How much visual weight the action carries. VButton overrides not a single value of the shared tone table, which is why it is the reference.',
  variantsElevation:
  ...
  tonesRule:
    'One rule governs filled controls: they carry white text. Everything else bends to keep it true — the neutral solid is a full text/surface inversion, and its hover mixes TOWARDS <code>surface</code> rather than away from it, because there is no darker neutral to reach for.',
