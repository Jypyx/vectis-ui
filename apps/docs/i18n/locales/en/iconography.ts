export default {
  ...
  gridCaption:
    "Positions 3 and 4, as well as 6 and 7, illustrate the same symbol successively rendered in its 'outline' and 'filled' variants",
  ...
  sizingReason:
    "It is this second CSS cascade approach that allows control components (via <code>v-control</code>) to automatically adjust child icon sizes according to the parent component's size variant.",
