export default {
  ...
  dictionaries:
    "Les deux dictionnaires livrés. <code>en</code> est toujours embarqué ; <code>fr</code> est optionnel, et ne pas l'importer l'élague.",
  setIconResolver:
  ...
  ligatureResolver:
    "Résout un nom vers une ligature de police d'icônes, comme Material Symbols ou IcoMoon.",
  classResolver:
  ...
  componentResolver:
    'Résout un nom vers un composant de votre propre bibliothèque, comme Lucide ou Untitled UI.',
  toast:
    "Ajoute et retire une notification. C'est la seule API impérative de la bibliothèque, parce qu'une notification n'a pas sa place dans l'arbre qui la demande.",
