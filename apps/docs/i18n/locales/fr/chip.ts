export default {
  ...
  colourBody:
    "<code>color</code> remplace le ton, et chaque nuance en est dérivée avec <code>color-mix()</code>. C'est ce dont a besoin une liste d'étiquettes venue d'une base de données, dont les couleurs sont des données et non des décisions de design. Le clair et le sombre sont pris en charge pour vous.",

  apiHeading: 'API',
  apiColor: "<code>string</code> : n'importe quelle couleur CSS, et elle remplace le ton",
