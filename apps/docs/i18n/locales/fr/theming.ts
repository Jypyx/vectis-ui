export default {
  ...
  levels: [
    "<strong>Primitives</strong> — cinq palettes OKLCH de onze pas chacune (<code>--vectis-color-indigo-500</code>), plus l'échelle d'espacement, la typographie, les rayons, les ombres, les durées et les courbes.",
  ...
  palettes:
    "La bibliothèque livre cinq palettes et pas une de plus, parce que cinq est ce avec quoi elle peint — gray pour les surfaces, le texte et les bordures, indigo pour l'accent, puis red, green et amber pour danger, succès et avertissement. Une palette inutilisée reste onze propriétés personnalisées dans chaque page qui charge la feuille de styles : une sixième couleur revient donc à l'application. Déclarez ses onze pas sous votre propre nom, pointez le rôle vers eux, et c'est tout — rien à recompiler, aucune version à attendre. C'est exactement ce que fait ce site pour son accent violet.",
