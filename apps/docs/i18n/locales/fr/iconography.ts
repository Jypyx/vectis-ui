export default {
  ...
  partialBody:
    "Un résolveur qui répond <code>undefined</code> dit « je ne connais pas ce nom », et non « ne dessine rien » : VIcon retombe alors sur le registre, puis sur la ligature. C'est cette distinction qui rend utile de mapper six noms et de laisser le reste tranquille — ce que fait précisément ce site, dont le décor a besoin de six icônes que la bibliothèque n'a aucune raison de livrer.",
  partialQuote:
