export default {
  ...
  spread:
    "<code>spread</code> pousse le libellé et l'interrupteur aux extrémités opposées — la forme habituelle d'une liste de réglages, où les interrupteurs s'alignent alors le long d'un bord.",
  labelSlot:
