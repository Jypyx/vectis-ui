...
export default {
  ...
  cssVars: [
    ...
    { name: '--vectis-control-size-calendar-event-edge', value: '3px' },
    { name: '--vectis-control-size-calendar-gap', value: '0.125rem' },
    { name: '--vectis-control-size-calendar-grip', value: '1rem' },
    { name: '--vectis-control-size-calendar-grip-thickness', value: '2px' },
    { name: '--vectis-control-size-calendar-year-month', value: '13rem' },
