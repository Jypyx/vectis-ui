  ...
  components: [
    {
      ...
      props: [
        ...
        { name: 'tone', type: 'ProgressLinearTone', default: "'accent'" },
        { name: 'color', type: 'string' },
        { name: 'thickness', type: 'number | string' },
        { name: 'shape', type: 'ProgressLinearShape', default: "'rounded'" },
        { name: 'showValue', type: 'boolean', default: 'false' },
        { name: 'valuePosition', type: 'ProgressLinearValuePosition', default: "'center'" },
        { name: 'orientation', type: 'ProgressLinearOrientation', default: "'horizontal'" },
      ],
      slots: [
