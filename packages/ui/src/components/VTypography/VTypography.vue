...
@layer vectis.components {
  ...
  .v-typography[data-variant='body-xl'] {
    --typography-size: var(--vectis-text-body-xl-size);
    --typography-weight: var(--vectis-text-body-xl-weight);
    --typography-leading: var(--vectis-text-body-xl-leading);
  }
