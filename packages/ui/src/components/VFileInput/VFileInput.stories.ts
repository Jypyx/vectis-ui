...
} satisfies Meta<typeof VFileInput>
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 340px; display: grid; gap: 8px">
        <VFileInput v-bind="args" v-model="files" :label="t.attachment" :hint="t.dropHere" />
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 340px">
        <VFileInput v-bind="args" v-model="files" :label="t.attachments" :hint="t.dropHere" />
      </div>
    `,
  }),
}
...
export const Chips: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 340px">
        <VFileInput v-bind="args" v-model="files" :label="t.attachments" />
      </div>
    `,
  }),
  play: async ({ canvasElement }) => {
...
export const DragAndDrop: Story = {
  ...
  play: async ({ canvasElement }) => {
    const root = canvasElement.querySelector('.v-file-input')!
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 340px; display: grid; gap: 16px">
        <VFileInput v-for="size in sizes" :key="size" v-bind="args" :size="size" :label="size" />
        <VFileInput v-bind="args" compact label="md compact" />
      </div>
    `,
  }),
}
...
export const States: Story = {
  render: (args) => ({
    ...
    template: `
      <div style="width: 340px; display: grid; gap: 16px">
        <VFileInput v-bind="args" disabled :label="t.attachment" :model-value="picked" />
        <VFileInput v-bind="args" readonly :label="t.attachment" :model-value="picked" />
        <VFileInput v-bind="args" invalid :label="t.attachment" :hint="t.pdfOnly" />
      </div>
    `,
  }),
}
