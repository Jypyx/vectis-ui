...
export const Multiple: Story = {
  render: (args) => ({
    ...
    template: `
      <div style="display: grid; gap: 12px; justify-items: start">
        <VDatePicker v-bind="args" selection="multiple" v-model="value"/>
...
export const DisabledDates: Story = {
  render: (args) => ({
    ...
    template: `<VDatePicker v-bind="args" v-model="value" :disabled-dates="isWeekend" />`,
  }),
}
...
export const AdjacentMonths: Story = {
  render: (args) => ({
    ...
    setup: () => ({ args, value: ref('2026-06-10') }),
    template: `
      <VDatePicker v-bind="args" v-model="value" show-adjacent-days select-adjacent-days />
    `,
  }),
}
...
export const Events: Story = {
  render: (args) => ({
    ...
    template: `<VDatePicker v-bind="args" v-model="value" :events="events" />`,
  }),
}
  ...
  render: (args) => ({
    ...
    template: `
      <div style="display:flex; gap:24px; flex-wrap:wrap">
        <VDatePicker v-bind="args" v-model="value" locale="fr-FR" />
        <VDatePicker v-bind="args" v-model="value" locale="ar-EG" />
        <VDatePicker v-bind="args" v-model="value" locale="en-US" />
        <VDatePicker v-bind="args" v-model="value" locale="ru-RU" />
        <VDatePicker v-bind="args" v-model="value" locale="el-GR" />
        <VDatePicker v-bind="args" v-model="value" locale="ja-JP" />
        <VDatePicker v-bind="args" v-model="value" locale="zh-CN" />
        <VDatePicker v-bind="args" v-model="value" locale="th-TH" />
      </div>
    `,
  }),
}
