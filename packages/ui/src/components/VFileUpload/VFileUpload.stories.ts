...
import type { FileUploadRejection } from './VFileUpload.vue'
...
} satisfies Meta<typeof VFileUpload>
...
const body = (canvasElement: HTMLElement) =>
  canvasElement.querySelector<HTMLElement>('.v-file-upload-body')!
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 420px; display: grid; gap: 12px">
        <VFileUpload v-bind="args" v-model="files" :title="t.title" :subtitle="t.subtitle" />
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 420px">
        <VFileUpload v-bind="args" v-model="files" :title="t.dropOnly" :subtitle="t.dropOnlyHint" />
      </div>
    `,
  }),
  play: async ({ canvasElement }) => {
    const zone = canvasElement.querySelector<HTMLElement>('.v-file-upload-zone')!
...
export const Thumbnails: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 420px">
        <VFileUpload v-bind="args" v-model="files" :title="t.title" :subtitle="t.imagesOnly" />
      </div>
    `,
  }),
  play: async ({ canvasElement }) => {
    ...
    const image = canvasElement.querySelector<HTMLImageElement>('.v-file-upload-image')!
...
export const DragAndDrop: Story = {
  ...
  play: async ({ canvasElement }) => {
    const root = canvasElement.querySelector('.v-file-upload')!
    const zone = canvasElement.querySelector('.v-file-upload-zone')!
...
export const Limits: Story = {
  ...
  render: (args) => ({
    components: { VFileUpload },
    setup: () => ({ args, t, files: ref<File[]>([]), refused: ref<FileUploadRejection[]>([]) }),
    template: `
      <div style="width: 420px; display: grid; gap: 12px">
        <VFileUpload
          v-bind="args"
...
export const CustomSlots: Story = {
  args: { preview: 'bottom', multiple: true },
  render: (args) => ({
    components: { VFileUpload, VButton, VIcon },
    setup: () => ({
      args,
      t,
  ...
  render: (args) => ({
    ...
    template: `
      <div style="width: 420px; display: grid; gap: 20px">
        <VFileUpload v-bind="args" disabled :title="t.title" :subtitle="t.subtitle" />
        <VFileUpload
          v-bind="args"
          readonly
          preview="bottom"
