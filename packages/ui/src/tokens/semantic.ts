...
export const semantic = {
  ...
  control: {
    ...
    'size-dialog-sm': dimension('20rem', 'Largeur maximale de la Dialog sm'),
    'size-dialog-md': dimension('32rem', 'Largeur maximale de la Dialog md'),
    'size-dialog-lg': dimension('48rem', 'Largeur maximale de la Dialog lg'),
