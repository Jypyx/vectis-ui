...
export default defineConfig({
  ...
  build: {
     ...
     *
     * Firefox is named at the version the README documents, NOT at the oldest one that
     * would still run the library: this list is what esbuild lowers against, so naming
     * an older Firefox here silently re-enables lowering for the whole sheet — the very
