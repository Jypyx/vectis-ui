<p align="center">
  <a href="https://vectis-ui.com">
    <img src="https://vectis-ui.com/favicon.svg" alt="Vectis UI logo" width="96" />
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Jypyx/vectis-ui/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/vectis-ui" alt="MIT license" /></a>
</p>

<p align="center">
  <a href="https://vectis-ui.com">Documentation</a> ·
  <a href="https://vectis-ui.com/docs/installation/">Installation</a> ·
  <a href="https://github.com/Jypyx/vectis-ui/blob/main/CHANGELOG.md">Changelog</a> ·
  <a href="https://github.com/Jypyx/vectis-ui">GitHub</a>
</p>
...
Vectis UI follows [Semantic Versioning](https://semver.org/). While the version is still 0.x, a minor release can include breaking changes, so read the [changelog](https://github.com/Jypyx/vectis-ui/blob/main/CHANGELOG.md) before upgrading.

## Contributing

Bug reports and feature requests are welcome in the [issue tracker](https://github.com/Jypyx/vectis-ui/issues). To work on the library itself, see the [repository](https://github.com/Jypyx/vectis-ui).

## License

Vectis UI is released under the [MIT license](https://github.com/Jypyx/vectis-ui/blob/main/LICENSE).

The built-in icons are drawn from [Material Symbols](https://github.com/google/material-design-icons) by Google, used under the Apache License 2.0. See [NOTICE](https://github.com/Jypyx/vectis-ui/blob/main/NOTICE) for details.
